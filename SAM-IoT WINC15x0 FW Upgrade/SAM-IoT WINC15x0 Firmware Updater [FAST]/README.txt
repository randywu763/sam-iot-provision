...
NOTE: Before starting this process, please open the document "SAM-IoT Debugger FW Version" to make sure the Debugger firmware version is correct on your board.
If the Debugger firmware version is not set to the correct one, this procedure will fail...
...
5.  From a command line window, run the "winc_update" batch file
