...
#@@@TODO: Clean up this mess. Requires changes in qute a fes scripts, though.

CERTS_FOLDER = "cert/"

ROOT_CA_FILENAME_BASE = CERTS_FOLDER +'root-ca'
ROOT_CA_KEY_FILENAME = ROOT_CA_FILENAME_BASE + '.key'
ROOT_CA_CERT_FILENAME = ROOT_CA_FILENAME_BASE + '.crt'

SIGNER_CA_FILENAME_BASE = CERTS_FOLDER + 'signer-ca'
...
KIT_INFO_FILENAME_BASE = 'kit-info.json'
KIT_INFO_FILENAME = CERTS_FOLDER + 'kit-info.json'

DEVICE_FILENAME_BASE = CERTS_FOLDER + 'device'
DEVICE_CSR_FILENAME = DEVICE_FILENAME_BASE + '.csr'
DEVICE_CERT_FILENAME = DEVICE_FILENAME_BASE + '.crt'
DEVICE_CERT_FILENAME_SANDBOX =  DEVICE_FILENAME_BASE + "_sandbox.crt"
...
class mchpZTKitError(RuntimeError):
    pass
