...
def ca_create_device_csr(device_key_path=DEVICE_KEY_FILENAME, device_csr_path=DEVICE_CSR_FILENAME):
    # Load or create a signer CA key pair
    print('\nLoading signer CA key')
    signer_ca_priv_key = load_or_create_key(device_key_path)
    ...
    # Save CSR
    with open(device_csr_path, 'wb') as f:
