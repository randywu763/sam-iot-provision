...
/*!< 
    Identifier for the public key information element.
*/
...
static sint8	Cert_DecodeTime(uint8 *pu8Time, tstrSystemTime *pstrTime);
static void		X509Cert_Dump(tstrX509Cert *pstrCert);
...
Return
*********************************************************************/
static tstrX509AlgID *Cert_DecodeAlgID
(
...
Return
	None
*********************************************************************/
static sint8 Cert_DecodeDistinguishedName
(
tstrAsn1Context				*pstrX509Asn1Cxt,
uint32						u32Size,
...
Return
	None
*********************************************************************/
static sint8 Cert_DecodeX520Name
(
tstrAsn1Context	*pstrX509Asn1Cxt, 
uint32		 	u32Size, 
...
Return
*********************************************************************/
static sint8 Cert_DecodeRSAPubKey
(
tstrAsn1Context		*pstrX509Asn1Cxt,
...
Return
*********************************************************************/
static sint8 Cert_DecodeECCPubKey
(
tstrAsn1Context		*pstrX509Asn1Cxt, 
tstrAsn1Element		*pstrKeyParam,
tstrMemPool		*pstrMemPool,
...
)
{
	...
	if((pstrX509Asn1Cxt != NULL) && (pstrEcdsaKey != NULL) && (pstrKeyParam != NULL) && (pstrMemPool != NULL))
	{
		...
		if(strElem.u8Tag == ASN1_BIT_STRING)
		{
			...
			{
				strElem.u32Length -= 2;
				pstrEcdsaKey->strQ.u16Size = (uint16)(strElem.u32Length >> 1);
...
Return
*********************************************************************/
static sint8 Cert_DecodeSubjectPubKey
(
tstrAsn1Context		*pstrX509Asn1Cxt, 
uint32 				u32Size, 
tstrMemPool		*pstrMemPool,
...
Return
*********************************************************************/
static sint8 Cert_DecodeValidity
(
tstrAsn1Context	*pstrX509Asn1Cxt, 
uint32 			u32Size,
...
Return
*********************************************************************/
static sint8 Cert_DecodeTBSCertificate
(
tstrAsn1Context	*pstrX509Asn1Cxt, 
uint16 			u16CertSize, 
...
Return
*********************************************************************/
sint8 X509_DecodeEcdsaSignature
(
tstrAsn1Context	*pstrX509Asn1Cxt,
uint8			*pu8Sig,
uint16			*pu16SigSz
...
Return
*********************************************************************/
static sint8 Cert_DecodeSignature
(
tstrAsn1Context	*pstrX509Asn1Cxt, 
uint16 			u16SigSize, 
tstrX509Cert 	*pstrCert
