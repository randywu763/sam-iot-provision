...
${OBJECTDIR}/cryptoauthlib/lib/atcacert/atcacert_client.o: cryptoauthlib/lib/atcacert/atcacert_client.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/cryptoauthlib/lib/atcacert/atcacert_client.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m0plus -g -D__DEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/port" -I "./." -I "hpl/systick" -I "hal/utils/include" -I "hal/include" -I "hpl/pm" -I "hri" -I "hpl/gclk" -I "hpl/sercom" -I "hpl/sysctrl" -I "hpl/core" -I "hpl/dmac" -I "winc1500" -I "winc1500/driver/include" -I "examples" -I "cryptoauthlib/lib" -I "hpl/eic" -I "config" -I "stdio_redirect"  -I "samd21a/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/cryptoauthlib/lib/atcacert/atcacert_client.o.d" -o ${OBJECTDIR}/cryptoauthlib/lib/atcacert/atcacert_client.o cryptoauthlib/lib/atcacert/atcacert_client.c  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/cryptoauthlib/lib/atcacert/atcacert_client.o: cryptoauthlib/lib/atcacert/atcacert_client.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/cryptoauthlib/lib/atcacert/atcacert_client.o.d 
	@${RM} ${OBJECTDIR}/cryptoauthlib/lib/atcacert/atcacert_client.o 
	@${FIXDEPS} "${OBJECTDIR}/cryptoauthlib/lib/atcacert/atcacert_client.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -mcpu=cortex-m0plus  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -mthumb -I "hpl/port" -I "./." -I "hpl/systick" -I "hal/utils/include" -I "hal/include" -I "hpl/pm" -I "hri" -I "hpl/gclk" -I "hpl/sercom" -I "hpl/sysctrl" -I "hpl/core" -I "hpl/dmac" -I "winc1500" -I "winc1500/driver/include" -I "examples" -I "cryptoauthlib/lib" -I "hpl/eic" -I "config" -I "stdio_redirect"  -I "samd21a/include" -I "CMSIS/Core/Include"  -Os -ffunction-sections -mlong-calls -Wall -MMD -MF "${OBJECTDIR}/cryptoauthlib/lib/atcacert/atcacert_client.o.d" -o ${OBJECTDIR}/cryptoauthlib/lib/atcacert/atcacert_client.o cryptoauthlib/lib/atcacert/atcacert_client.c  -DXPRJ_Default=$(CND_CONF)  $(COMPARISON_BUILD) 
